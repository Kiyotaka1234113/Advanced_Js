...
export const ThemedButton = withTheme(ThemedButton);
...
export const ThemedCard = withTheme(ThemedCard);
...
export const ThemedText = withTheme(ThemedText);
...
export const ThemedInput = withTheme(ThemedInput);
...
export const ThemeSwitcher = withTheme(ThemeSwitcher);
